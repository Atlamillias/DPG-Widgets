...
class mv2dHistogramSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    Args:
        ...
        * xmin_range (float, optional): set the min x range value, the values under this min
        will be ignored.

        * xmax_range (float, optional): set the max x range value, the values over this max
        will be ignored.

        * ymin_range (float, optional): set the min y range value, the values under this min
        will be ignored.

        * ymax_range (float, optional): set the max y range value, the values over this max
        will be ignored. If all xmin, xmax, ymin and ymax are 0.0, then the values will be
        the min and max values of the series.

        * density (bool, optional): counts will be normalized, i.e. the PDF will be
        visualized.

        * outliers (bool, optional): exclude values outside the specified histogram range
        from the count used for normalizing.
    ...
    col_major: Property[bool] = ...
    @overload
    def __init__(self, x: Sequence[float], y: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., xbins: int = ..., ybins: int = ..., xmin_range: float = ..., xmax_range: float = ..., ymin_range: float = ..., ymax_range: float = ..., density: bool = ..., outliers: bool = ..., col_major: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(x: Sequence[float], y: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., xbins: int = ..., ybins: int = ..., xmin_range: float = ..., xmax_range: float = ..., ymin_range: float = ..., ymax_range: float = ..., density: bool = ..., outliers: bool = ..., col_major: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., xbins: int = ..., ybins: int = ..., xmin_range: float = ..., xmax_range: float = ..., ymin_range: float = ..., ymax_range: float = ..., density: bool = ..., outliers: bool = ..., col_major: bool = ..., **kwargs) -> None: ...
...
class mvActivatedHandler(SupportsCallback, HandlerType, BasicType):
    ...
    show: Property[bool] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., callback: Callable | None = ..., show: bool = ..., **kwargs) -> None: ...
...
class mvAnnotation(PlottingType, BasicType):
    ...
    color: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    clamped: Property[bool] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., default_value: Any = ..., offset: Sequence[float] = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., clamped: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., default_value: Any = ..., offset: Sequence[float] = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., clamped: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., offset: Sequence[float] = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., clamped: bool = ..., **kwargs) -> None: ...
...
class mvAreaSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    source: Property['Item'] = ...
    show: Property[bool] = ...
    fill: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    contribute_to_bounds: Property[bool] = ...
    @overload
    def __init__(self, x: Sequence[float], y: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., contribute_to_bounds: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(x: Sequence[float], y: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., contribute_to_bounds: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., contribute_to_bounds: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'source', 'show', 'fill', 'contribute_to_bounds'], Any]: ...


class mvAxisTag(BasicType):
    ...
    Args:
        ...
        * default_value (float, optional): color (Sequence[int], optional):.

        * auto_rounding (bool, optional): When enabled, the value displayed on the tag will
        be automatically rounded to the precision of other values displayed at axis' ticks.
        Only makes sense when label is not set, i.e. when the tag displays its location on
        the axis.

    Command: `dearpygui.add_axis_tag`
    """
    __slots__: tuple[str, ...] = ()
    label: Property[str | None] = ...
    user_data: Property[Any] = ...
    ...
    show: Property[bool] = ...
    color: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    auto_rounding: Property[bool] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., default_value: float = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., auto_rounding: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., default_value: float = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., auto_rounding: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., auto_rounding: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'source', 'show', 'color', 'auto_rounding'], Any]: ...


class mvBarGroupSeries(SupportsValueArray, PlottingType, BasicType):
    """Adds a bar groups series to a plot.

    Args:
        * values (Any): label_ids (Sequence[str]): Label of each bar in a group.
        ...
        * shift (int, optional): The position on the x axis where to start plotting bar
        groups.

        * horizontal (bool, optional): bar groups will be rendered horizontally on the
        current y-axis.

        * stacked (bool, optional): items in a group will be stacked on top of each other.

    Command: `dearpygui.add_bar_group_series`
    """
    __slots__: tuple[str, ...] = ()
    label: Property[str | None] = ...
    user_data: Property[Any] = ...
    ...
    source: Property['Item'] = ...
    show: Property[bool] = ...
    group_width: Property[float] = ...
    shift: Property[int] = ...
    horizontal: Property[bool] = ...
    stacked: Property[bool] = ...
    @overload
    def __init__(self, values: Sequence[float], label_ids: Sequence[str], group_size: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., group_width: float = ..., shift: int = ..., horizontal: bool = ..., stacked: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(values: Sequence[float], label_ids: Sequence[str], group_size: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., group_width: float = ..., shift: int = ..., horizontal: bool = ..., stacked: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., group_width: float = ..., shift: int = ..., horizontal: bool = ..., stacked: bool = ..., **kwargs) -> None: ...
...
class mvBarSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    Args:
        ...
        * weight (float, optional): horizontal (bool, optional): bars will be rendered
        horizontally on the current y-axis.
    ...
    horizontal: Property[bool] = ...
    @overload
    def __init__(self, x: Sequence[float], y: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., weight: float = ..., horizontal: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(x: Sequence[float], y: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., weight: float = ..., horizontal: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., weight: float = ..., horizontal: bool = ..., **kwargs) -> None: ...
...
class mvBoolValue(BasicType):
    ...
    source: Property['Item'] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., source: 'Item' = ..., default_value: bool = ..., parent: 'Item' = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., source: 'Item' = ..., default_value: bool = ..., parent: 'Item' = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., **kwargs) -> None: ...
...
class mvButton(SupportsSized, SupportsCallback, BasicType):
    ...
    repeat: Property[bool] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., small: bool = ..., arrow: bool = ..., direction: int = ..., repeat: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., small: bool = ..., arrow: bool = ..., direction: int = ..., repeat: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., small: bool = ..., arrow: bool = ..., direction: int = ..., repeat: bool = ..., **kwargs) -> None: ...
...
class mvCandleSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    source: Property['Item'] = ...
    show: Property[bool] = ...
    bull_color: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    bear_color: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    weight: Property[float] = ...
    tooltip: Property[bool] = ...
    time_unit: Property[int] = ...
    @overload
    def __init__(self, dates: Sequence[float], opens: Sequence[float], closes: Sequence[float], lows: Sequence[float], highs: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., bull_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., bear_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., weight: float = ..., tooltip: bool = ..., time_unit: int = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(dates: Sequence[float], opens: Sequence[float], closes: Sequence[float], lows: Sequence[float], highs: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., bull_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., bear_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., weight: float = ..., tooltip: bool = ..., time_unit: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., bull_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., bear_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., weight: float = ..., tooltip: bool = ..., time_unit: int = ..., **kwargs) -> None: ...
...
class mvCharRemap(BasicType):
    ...
    use_internal_label: Property[bool] = ...
    @overload
    def __init__(self, source: int, target: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(source: int, target: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., **kwargs) -> None: ...
...
class mvCheckbox(SupportsCallback, BasicType):
    ...
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., **kwargs) -> None: ...
...
class mvChildWindow(SupportsSized, WindowType, ContainerType, BasicType):
    """Adds an embedded child window. Will show scrollbars when items do not fit. About using
    auto_resize/resizable flags: size measurement for a given axis is only performed when
    the child window is within visible boundaries, or is just appearing and it won't update
    its auto-size while clipped. While not perfect, it is a better default behavior as the
    always-on performance gain is more valuable than the occasional 'resizing after becoming
    visible again' glitch. You may also use always_auto_resize to force an update even when
    child window is not in view. However doing so will degrade performance. Remember that
    combining both auto_resize_x and auto_resize_y defeats purpose of a scrolling region and
    is NOT recommended.
    ...
    Args:
        ...
        * no_scroll_with_mouse (bool, optional): Disable user vertically scrolling with
        mouse wheel.

        * flattened_navigation (bool, optional): Allow gamepad/keyboard navigation to cross
        over parent border to this child (only use on child that have no scrolling!).

        * always_use_window_padding (bool, optional): Pad with style.WindowPadding even if
        no border are drawn (no padding by default for non-bordered child windows because it
        makes more sense).

        * resizable_x (bool, optional): Allow resize from right border (layout direction).
        Enable .ini saving.

        * resizable_y (bool, optional): Allow resize from bottom border (layout direction).

        * always_auto_resize (bool, optional): Combined with auto_resize_x/auto_resize_y.
        Always measure size even when child is hidden and always disable clipping
        optimization! NOT RECOMMENDED.

        * frame_style (bool, optional): Style the child window like a framed item: use
        FrameBg, FrameRounding, FrameBorderSize, FramePadding instead of ChildBg,
        ChildRounding, ChildBorderSize, WindowPadding.

        * auto_resize_x (bool, optional): Enable auto-resizing width based on child content.
        Read 'IMPORTANT: Size measurement' details above.

        * auto_resize_y (bool, optional): Enable auto-resizing height based on child
        content. Read 'IMPORTANT: Size measurement' details above.
...
class mvClickedHandler(SupportsCallback, HandlerType, BasicType):
    ...
    show: Property[bool] = ...
    @overload
    def __init__(self, button: int = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(button: int = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., callback: Callable | None = ..., show: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'callback', 'show'], Any]: ...
...
class mvClipper(ContainerType, BasicType):
    ...
    show: Property[bool] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., delay_search: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., delay_search: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., indent: int = ..., show: bool = ..., **kwargs) -> None: ...
...
class mvCollapsingHeader(ContainerType, BasicType):
    ...
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., closable: bool = ..., default_open: bool = ..., open_on_double_click: bool = ..., open_on_arrow: bool = ..., leaf: bool = ..., bullet: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., closable: bool = ..., open_on_double_click: bool = ..., open_on_arrow: bool = ..., leaf: bool = ..., bullet: bool = ..., **kwargs) -> None: ...
...
class mvColorButton(SupportsSized, SupportsCallback, BasicType):
    ...
    @overload
    def __init__(self, default_value: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., no_alpha: bool = ..., no_border: bool = ..., no_drag_drop: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(default_value: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., no_alpha: bool = ..., no_border: bool = ..., no_drag_drop: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., no_alpha: bool = ..., no_border: bool = ..., no_drag_drop: bool = ..., **kwargs) -> None: ...
...
class mvColorEdit(SupportsSized, SupportsCallback, BasicType):
    ...
    @staticmethod
    def command(default_value: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., no_alpha: bool = ..., no_picker: bool = ..., no_options: bool = ..., no_small_preview: bool = ..., no_inputs: bool = ..., no_tooltip: bool = ..., no_label: bool = ..., no_drag_drop: bool = ..., alpha_bar: bool = ..., alpha_preview: int = ..., display_mode: int = ..., display_type: int = ..., input_mode: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., no_alpha: bool = ..., no_picker: bool = ..., no_options: bool = ..., no_small_preview: bool = ..., no_inputs: bool = ..., no_tooltip: bool = ..., no_label: bool = ..., no_drag_drop: bool = ..., alpha_bar: bool = ..., alpha_preview: int = ..., display_mode: int = ..., display_type: int = ..., input_mode: int = ..., **kwargs) -> None: ...
...
class mvColorMap(BasicType):
    ...
    show: Property[bool] = ...
    @overload
    def __init__(self, colors: tuple[int, int, int] | tuple[int, int, int, int] | list[int], qualitative: bool, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., show: bool = ..., parent: 'Item' = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(colors: tuple[int, int, int] | tuple[int, int, int, int] | list[int], qualitative: bool, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., show: bool = ..., parent: 'Item' = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., **kwargs) -> None: ...
...
class mvColorMapRegistry(RegistryType):
    ...
    show: Property[bool] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., show: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., show: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'show'], Any]: ...
...
class mvColorMapScale(SupportsSized, BasicType):
    ...
    Args:
        ...
        * reverse_dir (bool, optional): invert the colormap bar and axis scale (this only
        affects rendering; if you only want to reverse the scale mapping, make scale_min >
        scale_max).

        * mirror (bool, optional): render the colormap label and tick labels on the opposite
        side.
    ...
    format: Property[str] = ...
    reverse_dir: Property[bool] = ...
    mirror: Property[bool] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., colormap: 'Item' = ..., min_scale: float = ..., max_scale: float = ..., format: str = ..., reverse_dir: bool = ..., mirror: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., colormap: 'Item' = ..., min_scale: float = ..., max_scale: float = ..., format: str = ..., reverse_dir: bool = ..., mirror: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., source: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., colormap: 'Item' = ..., min_scale: float = ..., max_scale: float = ..., format: str = ..., reverse_dir: bool = ..., mirror: bool = ..., **kwargs) -> None: ...
...
class mvColorMapSlider(SupportsSized, SupportsCallback, BasicType):
    ...
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: float = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., payload_type: str = ..., callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., **kwargs) -> None: ...
...
class mvColorValue(BasicType):
    ...
    source: Property['Item'] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., source: 'Item' = ..., default_value: Sequence[float] = ..., parent: 'Item' = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., source: 'Item' = ..., default_value: Sequence[float] = ..., parent: 'Item' = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'source'], Any]: ...
...
class mvCombo(SupportsCallback, BasicType):
    ...
    fit_width: Property[bool] = ...
    height_mode: Property[int] = ...
    @overload
    def __init__(self, items: Sequence[str] = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: str = ..., popup_align_left: bool = ..., no_arrow_button: bool = ..., no_preview: bool = ..., fit_width: bool = ..., height_mode: int = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(items: Sequence[str] = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: str = ..., popup_align_left: bool = ..., no_arrow_button: bool = ..., no_preview: bool = ..., fit_width: bool = ..., height_mode: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., indent: int = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., popup_align_left: bool = ..., no_arrow_button: bool = ..., no_preview: bool = ..., fit_width: bool = ..., height_mode: int = ..., **kwargs) -> None: ...
...
class mvCustomSeries(SupportsValueArray, SupportsCallback, PlottingType, ContainerType, BasicType):
    ...
    y3: Property[Any] = ...
    tooltip: Property[bool] = ...
    no_fit: Property[bool] = ...
    @overload
    def __init__(self, x: Sequence[float], y: Sequence[float], channel_count: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., y1: Any = ..., y2: Any = ..., y3: Any = ..., tooltip: bool = ..., no_fit: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(x: Sequence[float], y: Sequence[float], channel_count: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., y1: Any = ..., y2: Any = ..., y3: Any = ..., tooltip: bool = ..., no_fit: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., y1: Any = ..., y2: Any = ..., y3: Any = ..., tooltip: bool = ..., no_fit: bool = ..., **kwargs) -> None: ...
...
class mvDatePicker(SupportsCallback, BasicType):
    ...
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: dict = ..., level: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., level: int = ..., **kwargs) -> None: ...
...
class mvDigitalSeries(SupportsValueArray, PlottingType, BasicType):
    """Adds a digital series to a plot. Digital plots do not respond to y drag or zoom, and are
    ...
    Command: `dearpygui.add_digital_series`
    """
    __slots__: tuple[str, ...] = ()
    label: Property[str | None] = ...
    user_data: Property[Any] = ...
    ...
    show: Property[bool] = ...
    @overload
    def __init__(self, x: Sequence[float], y: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(x: Sequence[float], y: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., **kwargs) -> None: ...
...
class mvDouble4Value(BasicType):
    ...
    source: Property['Item'] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., source: 'Item' = ..., default_value: Any = ..., parent: 'Item' = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., source: 'Item' = ..., default_value: Any = ..., parent: 'Item' = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'source'], Any]: ...
...
class mvDoubleValue(BasicType):
    ...
    source: Property['Item'] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., source: 'Item' = ..., default_value: float = ..., parent: 'Item' = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., source: 'Item' = ..., default_value: float = ..., parent: 'Item' = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'source'], Any]: ...
...
class mvDragIntMulti(SupportsCallback, BasicType):
    ...
    clamped: Property[bool] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., size: int = ..., format: str = ..., speed: float = ..., min_value: int = ..., max_value: int = ..., no_input: bool = ..., clamped: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., size: int = ..., format: str = ..., speed: float = ..., min_value: int = ..., max_value: int = ..., no_input: bool = ..., clamped: bool = ..., **kwargs) -> Item: ...
...
class mvDragLine(SupportsCallback, BasicType):
    ...
    Args:
        ...
        * vertical (bool, optional): delayed (bool, optional): tool rendering will be
        delayed one frame; useful when applying position-constraints.

        * no_cursor (bool, optional): drag tools won't change cursor icons when hovered or
        held.
    ...
    delayed: Property[bool] = ...
    no_cursor: Property[bool] = ...
    no_fit: Property[bool] = ...
    no_inputs: Property[bool] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., default_value: float = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., show_label: bool = ..., vertical: bool = ..., delayed: bool = ..., no_cursor: bool = ..., no_fit: bool = ..., no_inputs: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., default_value: float = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., show_label: bool = ..., vertical: bool = ..., delayed: bool = ..., no_cursor: bool = ..., no_fit: bool = ..., no_inputs: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., show_label: bool = ..., vertical: bool = ..., delayed: bool = ..., no_cursor: bool = ..., no_fit: bool = ..., no_inputs: bool = ..., **kwargs) -> None: ...
...
class mvDragPayload(ContainerType, BasicType):
    ...
    payload_type: Property[str] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., show: bool = ..., drag_data: Any = ..., drop_data: Any = ..., payload_type: str = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., show: bool = ..., drag_data: Any = ..., drop_data: Any = ..., payload_type: str = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., drag_data: Any = ..., drop_data: Any = ..., payload_type: str = ..., **kwargs) -> None: ...
...
class mvDragPoint(SupportsCallback, BasicType):
    ...
    Args:
        ...
        * offset (Sequence[float], optional): Offset of the label, in pixels, relative to
        the drag point itself.

        * clamped (bool, optional): Keep the label within the visible area of the plot even
        if the drag point itself goes outside of the visible area.

        * delayed (bool, optional): tool rendering will be delayed one frame; useful when
    ...
    no_inputs: Property[bool] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., default_value: Any = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., show_label: bool = ..., offset: Sequence[float] = ..., clamped: bool = ..., delayed: bool = ..., no_cursor: bool = ..., no_fit: bool = ..., no_inputs: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., default_value: Any = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., show_label: bool = ..., offset: Sequence[float] = ..., clamped: bool = ..., delayed: bool = ..., no_cursor: bool = ..., no_fit: bool = ..., no_inputs: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., show_label: bool = ..., offset: Sequence[float] = ..., clamped: bool = ..., delayed: bool = ..., no_cursor: bool = ..., no_fit: bool = ..., no_inputs: bool = ..., **kwargs) -> None: ...
...
class mvDragRect(SupportsCallback, BasicType):
    ...
    Args:
        ...
        * default_value (Any, optional): The coordinates are specified in a sequence of:
        (xmin, ymin, xmax, ymax).

        * color (Sequence[int], optional): delayed (bool, optional): tool rendering will be
        delayed one frame; useful when applying position-constraints.
    ...
    Command: `dearpygui.add_drag_rect`
    """
    __slots__: tuple[str, ...] = ()
    label: Property[str | None] = ...
    user_data: Property[Any] = ...
    ...
    no_inputs: Property[bool] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., default_value: Any = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., delayed: bool = ..., no_cursor: bool = ..., no_fit: bool = ..., no_inputs: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., default_value: Any = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., delayed: bool = ..., no_cursor: bool = ..., no_fit: bool = ..., no_inputs: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., delayed: bool = ..., no_cursor: bool = ..., no_fit: bool = ..., no_inputs: bool = ..., **kwargs) -> None: ...
...
class mvDrawArrow(DrawingType, BasicType):
    ...
    size: Property[int] = ...
    @overload
    def __init__(self, p1: Sequence[float], p2: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., size: int = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(p1: Sequence[float], p2: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., size: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., size: int = ..., **kwargs) -> None: ...
...
class mvDrawBezierCubic(DrawingType, BasicType):
    ...
    @overload
    def __init__(self, p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], p4: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], p4: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> None: ...
...
class mvDrawBezierQuadratic(DrawingType, BasicType):
    ...
    segments: Property[int] = ...
    @overload
    def __init__(self, p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'show', 'color', 'thickness', 'segments'], Any]: ...
...
class mvDrawCircle(DrawingType, BasicType):
    ...
    segments: Property[int] = ...
    @overload
    def __init__(self, center: Sequence[float], radius: float, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(center: Sequence[float], radius: float, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> None: ...
...
class mvDrawEllipse(DrawingType, BasicType):
    ...
    segments: Property[int] = ...
    @overload
    def __init__(self, pmin: Sequence[float], pmax: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(pmin: Sequence[float], pmax: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'show', 'color', 'fill', 'thickness', 'segments'], Any]: ...
...
class mvDrawImage(DrawingType, BasicType):
    ...
    color: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    @overload
    def __init__(self, texture_tag: 'Item', pmin: Sequence[float], pmax: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(texture_tag: 'Item', pmin: Sequence[float], pmax: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., **kwargs) -> None: ...
...
class mvDrawImageQuad(DrawingType, BasicType):
    ...
    color: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    @overload
    def __init__(self, texture_tag: 'Item', p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], p4: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., uv1: Sequence[float] = ..., uv2: Sequence[float] = ..., uv3: Sequence[float] = ..., uv4: Sequence[float] = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(texture_tag: 'Item', p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], p4: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., uv1: Sequence[float] = ..., uv2: Sequence[float] = ..., uv3: Sequence[float] = ..., uv4: Sequence[float] = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., uv1: Sequence[float] = ..., uv2: Sequence[float] = ..., uv3: Sequence[float] = ..., uv4: Sequence[float] = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., **kwargs) -> None: ...
...
class mvDrawLayer(DrawingType, ContainerType, BasicType):
    ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., perspective_divide: bool = ..., depth_clipping: bool = ..., cull_mode: int = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., perspective_divide: bool = ..., depth_clipping: bool = ..., cull_mode: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., perspective_divide: bool = ..., depth_clipping: bool = ..., cull_mode: int = ..., **kwargs) -> None: ...
...
class mvDrawLine(DrawingType, BasicType):
    ...
    thickness: Property[float] = ...
    @overload
    def __init__(self, p1: Sequence[float], p2: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(p1: Sequence[float], p2: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., **kwargs) -> None: ...
...
class mvDrawNode(DrawNodeType, ContainerType, BasicType):
    ...
    show: Property[bool] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'show'], Any]: ...
...
class mvDrawPolygon(DrawingType, BasicType):
    ...
    thickness: Property[float] = ...
    @overload
    def __init__(self, points: Sequence[Sequence[float]], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(points: Sequence[Sequence[float]], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., **kwargs) -> None: ...
...
class mvDrawPolyline(DrawingType, BasicType):
    ...
    thickness: Property[float] = ...
    @overload
    def __init__(self, points: Sequence[Sequence[float]], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., closed: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(points: Sequence[Sequence[float]], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., closed: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., closed: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., **kwargs) -> None: ...
...
class mvDrawQuad(DrawingType, BasicType):
    ...
    thickness: Property[float] = ...
    @overload
    def __init__(self, p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], p4: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], p4: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'show', 'color', 'fill', 'thickness'], Any]: ...
...
class mvDrawRect(DrawingType, BasicType):
    ...
    Args:
        ...
        * multicolor (bool, optional): rounding (float, optional): Number of pixels of the
        radius that will round the corners of the rectangle. Note: doesn't work with
        multicolor.

        * thickness (float, optional): corner_colors (Any, optional): Corner colors in a
        list, starting with upper-left and going clockwise: (upper-left, upper-right,
        bottom-right, bottom-left). 'multicolor' must be set to 'True'.
    ...
    color: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    fill: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    multicolor: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    rounding: Property[float] = ...
    thickness: Property[float] = ...
    corner_colors: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    @overload
    def __init__(self, pmin: Sequence[float], pmax: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., multicolor: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., rounding: float = ..., thickness: float = ..., corner_colors: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(pmin: Sequence[float], pmax: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., multicolor: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., rounding: float = ..., thickness: float = ..., corner_colors: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., multicolor: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., rounding: float = ..., thickness: float = ..., corner_colors: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., **kwargs) -> None: ...
...
class mvDrawText(DrawingType, BasicType):
    ...
    size: Property[float] = ...
    @overload
    def __init__(self, pos: tuple[int, int] | list[int], text: str, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., size: float = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(pos: tuple[int, int] | list[int], text: str, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., size: float = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., size: float = ..., **kwargs) -> None: ...
...
class mvDrawTriangle(DrawingType, BasicType):
    ...
    thickness: Property[float] = ...
    @overload
    def __init__(self, p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'show', 'color', 'fill', 'thickness'], Any]: ...
...
class mvDrawlist(SupportsSized, SupportsCallback, DrawingType, ContainerType, BasicType):
    ...
    track_offset: Property[float] = ...
    @overload
    def __init__(self, width: int, height: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(width: int, height: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., **kwargs) -> None: ...
...
class mvDynamicTexture(BasicType):
    ...
    use_internal_label: Property[bool] = ...
    @overload
    def __init__(self, width: int, height: int, default_value: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(width: int, height: int, default_value: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label'], Any]: ...
...
class mvErrorSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    horizontal: Property[bool] = ...
    @overload
    def __init__(self, x: Sequence[float], y: Sequence[float], negative: Sequence[float], positive: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., contribute_to_bounds: bool = ..., horizontal: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(x: Sequence[float], y: Sequence[float], negative: Sequence[float], positive: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., contribute_to_bounds: bool = ..., horizontal: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., contribute_to_bounds: bool = ..., horizontal: bool = ..., **kwargs) -> None: ...
...
class mvFileDialog(SupportsCallback, RootType):
    ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., callback: Callable | None = ..., show: bool = ..., default_path: str = ..., default_filename: str = ..., file_count: int = ..., modal: bool = ..., directory_selector: bool = ..., min_size: Sequence[int] = ..., max_size: Sequence[int] = ..., cancel_callback: Callable | None = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., callback: Callable | None = ..., show: bool = ..., default_path: str = ..., default_filename: str = ..., file_count: int = ..., modal: bool = ..., directory_selector: bool = ..., min_size: Sequence[int] = ..., max_size: Sequence[int] = ..., cancel_callback: Callable | None = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., callback: Callable | None = ..., show: bool = ..., file_count: int = ..., modal: bool = ..., directory_selector: bool = ..., min_size: Sequence[int] = ..., max_size: Sequence[int] = ..., cancel_callback: Callable | None = ..., **kwargs) -> None: ...
...
class mvFileExtension(BasicType):
    ...
    color: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    @overload
    def __init__(self, extension: str, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., parent: 'Item' = ..., before: 'Item' = ..., custom_text: str = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(extension: str, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., parent: 'Item' = ..., before: 'Item' = ..., custom_text: str = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., custom_text: str = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., **kwargs) -> None: ...
...
class mvFont(FontType, ContainerType, BasicType):
    ...
    Args:
        ...
        * pixel_snapH (bool, optional): Align every glyph to pixel boundary. Useful e.g. if
        you are merging a non-pixel aligned font with the default font, or rendering text
        piece-by-piece (e.g. for coloring).
    ...
    user_data: Property[Any] = ...
    use_internal_label: Property[bool] = ...
    pixel_snapH: Property[bool] = ...
    @overload
    def __init__(self, file: str, size: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., pixel_snapH: bool = ..., parent: 'Item' = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(file: str, size: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., pixel_snapH: bool = ..., parent: 'Item' = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., pixel_snapH: bool = ..., **kwargs) -> None: ...
...
class mvFontChars(BasicType):
    ...
    use_internal_label: Property[bool] = ...
    @overload
    def __init__(self, chars: Sequence[int], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(chars: Sequence[int], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label'], Any]: ...
...
class mvFontRange(BasicType):
    ...
    use_internal_label: Property[bool] = ...
    @overload
    def __init__(self, first_char: int, last_char: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(first_char: int, last_char: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label'], Any]: ...
...
class mvFontRangeHint(BasicType):
    ...
    use_internal_label: Property[bool] = ...
    @overload
    def __init__(self, hint: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(hint: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label'], Any]: ...
...
class mvGroup(SupportsSized, ContainerType, BasicType):
    ...
    issued for all of its members. Enable property acts in a special way enabling/disabling
    everything inside the group. (Use mvStyleVar_DisabledAlpha to edit colors within the
    disabled group.).
    ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., horizontal: bool = ..., horizontal_spacing: float = ..., xoffset: float = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., horizontal: bool = ..., horizontal_spacing: float = ..., xoffset: float = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., horizontal: bool = ..., horizontal_spacing: float = ..., xoffset: float = ..., **kwargs) -> None: ...
...
class mvHeatSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    col_major: Property[bool] = ...
    @overload
    def __init__(self, x: Sequence[float], rows: int, cols: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., scale_min: float = ..., scale_max: float = ..., bounds_min: Any = ..., bounds_max: Any = ..., format: str = ..., contribute_to_bounds: bool = ..., col_major: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(x: Sequence[float], rows: int, cols: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., scale_min: float = ..., scale_max: float = ..., bounds_min: Any = ..., bounds_max: Any = ..., format: str = ..., contribute_to_bounds: bool = ..., col_major: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., scale_min: float = ..., scale_max: float = ..., bounds_min: Any = ..., bounds_max: Any = ..., format: str = ..., contribute_to_bounds: bool = ..., col_major: bool = ..., **kwargs) -> None: ...
...
class mvHistogramSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    Args:
        ...
        * min_range (float, optional): set the min range value, the values under this min
        will be ignored.

        * max_range (float, optional): set the max range value, the values over this max
        will be ignored. If both min and max are 0.0, then the values will be the min and
        max values of the series.

        * cumulative (bool, optional): each bin will contain its count plus the counts of
        all previous bins.

        * density (bool, optional): counts will be normalized, i.e. the PDF will be
        visualized, or the CDF will be visualized if Cumulative is also set.

        * outliers (bool, optional): exclude values outside the specifed histogram range
    ...
    cumulative: Property[bool] = ...
    density: Property[bool] = ...
    outliers: Property[bool] = ...
    horizontal: Property[bool] = ...
    contribute_to_bounds: Property[bool] = ...
    @overload
    def __init__(self, x: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., bins: int = ..., bar_scale: float = ..., min_range: float = ..., max_range: float = ..., cumulative: bool = ..., density: bool = ..., outliers: bool = ..., horizontal: bool = ..., contribute_to_bounds: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(x: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., bins: int = ..., bar_scale: float = ..., min_range: float = ..., max_range: float = ..., cumulative: bool = ..., density: bool = ..., outliers: bool = ..., horizontal: bool = ..., contribute_to_bounds: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., bins: int = ..., bar_scale: float = ..., min_range: float = ..., max_range: float = ..., cumulative: bool = ..., density: bool = ..., outliers: bool = ..., horizontal: bool = ..., contribute_to_bounds: bool = ..., **kwargs) -> None: ...
...
class mvImage(SupportsSized, BasicType):
    ...
    tracked: Property[bool] = ...
    track_offset: Property[float] = ...
    tint_color: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    border_color: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    uv_min: Property[Sequence[float]] = ...
    uv_max: Property[Sequence[float]] = ...
    @overload
    def __init__(self, texture_tag: 'Item', *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., tint_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., border_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(texture_tag: 'Item', *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., tint_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., border_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., source: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., tint_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., border_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., **kwargs) -> None: ...
...
class mvImageButton(SupportsSized, SupportsCallback, BasicType):
    ...
    track_offset: Property[float] = ...
    tint_color: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    background_color: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    uv_min: Property[Sequence[float]] = ...
    uv_max: Property[Sequence[float]] = ...
    @overload
    def __init__(self, texture_tag: 'Item', *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., tint_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., background_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(texture_tag: 'Item', *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., tint_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., background_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., tint_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., background_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., **kwargs) -> None: ...
...
class mvImageSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    tint_color: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    @overload
    def __init__(self, texture_tag: 'Item', bounds_min: Sequence[float], bounds_max: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., tint_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(texture_tag: 'Item', bounds_min: Sequence[float], bounds_max: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., tint_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., tint_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'source', 'show', 'uv_min', 'uv_max', 'tint_color'], Any]: ...


class mvInfLineSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    Command: `dearpygui.add_inf_line_series`
    """
    __slots__: tuple[str, ...] = ()
    label: Property[str | None] = ...
    user_data: Property[Any] = ...
    ...
    horizontal: Property[bool] = ...
    @overload
    def __init__(self, x: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., horizontal: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(x: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., horizontal: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., horizontal: bool = ..., **kwargs) -> None: ...
...
class mvInputIntMulti(SupportsCallback, BasicType):
    ...
    readonly: Property[bool] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., min_value: int = ..., max_value: int = ..., size: int = ..., min_clamped: bool = ..., max_clamped: bool = ..., on_enter: bool = ..., readonly: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., min_value: int = ..., max_value: int = ..., size: int = ..., min_clamped: bool = ..., max_clamped: bool = ..., on_enter: bool = ..., readonly: bool = ..., **kwargs) -> Item: ...
...
class mvInputText(SupportsSized, SupportsCallback, BasicType):
    ...
    Args:
        ...
        * auto_select_all (bool, optional): Select entire text when first taking mouse
        focus.

        * ctrl_enter_for_new_line (bool, optional): In multi-line mode, unfocus with Enter,
        add new line with Ctrl+Enter (default is opposite: unfocus with Ctrl+Enter, add line
        with Enter).
        ...
        * escape_clears_all (bool, optional): Escape key clears content if not empty, and
        deactivate otherwise (contrast to default behavior of Escape to revert).
    ...
    on_enter: Property[bool] = ...
    auto_select_all: Property[bool] = ...
    ctrl_enter_for_new_line: Property[bool] = ...
    no_horizontal_scroll: Property[bool] = ...
    always_overwrite: Property[bool] = ...
    no_undo_redo: Property[bool] = ...
    escape_clears_all: Property[bool] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: str = ..., hint: str = ..., multiline: bool = ..., no_spaces: bool = ..., uppercase: bool = ..., tab_input: bool = ..., decimal: bool = ..., hexadecimal: bool = ..., readonly: bool = ..., password: bool = ..., scientific: bool = ..., on_enter: bool = ..., auto_select_all: bool = ..., ctrl_enter_for_new_line: bool = ..., no_horizontal_scroll: bool = ..., always_overwrite: bool = ..., no_undo_redo: bool = ..., escape_clears_all: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: str = ..., hint: str = ..., multiline: bool = ..., no_spaces: bool = ..., uppercase: bool = ..., tab_input: bool = ..., decimal: bool = ..., hexadecimal: bool = ..., readonly: bool = ..., password: bool = ..., scientific: bool = ..., on_enter: bool = ..., auto_select_all: bool = ..., ctrl_enter_for_new_line: bool = ..., no_horizontal_scroll: bool = ..., always_overwrite: bool = ..., no_undo_redo: bool = ..., escape_clears_all: bool = ..., **kwargs) -> Item: ...
...
class mvInt4Value(BasicType):
    ...
    source: Property['Item'] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., source: 'Item' = ..., default_value: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., parent: 'Item' = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., source: 'Item' = ..., default_value: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., parent: 'Item' = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'source'], Any]: ...
...
class mvIntValue(BasicType):
    ...
    source: Property['Item'] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., source: 'Item' = ..., default_value: int = ..., parent: 'Item' = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., source: 'Item' = ..., default_value: int = ..., parent: 'Item' = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'source'], Any]: ...
...
class mvKeyDownHandler(SupportsCallback, HandlerType, BasicType):
    ...
    show: Property[bool] = ...
    @overload
    def __init__(self, key: int = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., parent: 'Item' = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(key: int = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., parent: 'Item' = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., callback: Callable | None = ..., show: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'callback', 'show'], Any]: ...
...
class mvKnobFloat(SupportsSized, SupportsCallback, BasicType):
    ...
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: float = ..., min_value: float = ..., max_value: float = ..., **kwargs) -> Item: ...
...
class mvLabelSeries(PlottingType, BasicType):
    ...
    vertical: Property[bool] = ...
    @overload
    def __init__(self, x: float, y: float, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., offset: Sequence[float] = ..., vertical: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(x: float, y: float, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., offset: Sequence[float] = ..., vertical: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., offset: Sequence[float] = ..., vertical: bool = ..., **kwargs) -> None: ...
...
class mvLineSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    Args:
        ...
        * segments (bool, optional): a line segment will be rendered from every two
        consecutive points.

        * loop (bool, optional): the last and first point will be connected to form a closed
        loop.

        * skip_nan (bool, optional): NaNs values will be skipped instead of rendered as
        missing data.

        * no_clip (bool, optional): markers (if displayed) on the edge of a plot will not be
        clipped.

        * shaded (bool, optional): a filled region between the line and horizontal origin
        will be rendered; use add_shade_series for more advanced cases.
    ...
    source: Property['Item'] = ...
    show: Property[bool] = ...
    segments: Property[bool] = ...
    loop: Property[bool] = ...
    skip_nan: Property[bool] = ...
    no_clip: Property[bool] = ...
    shaded: Property[bool] = ...
    @overload
    def __init__(self, x: Sequence[float], y: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., segments: bool = ..., loop: bool = ..., skip_nan: bool = ..., no_clip: bool = ..., shaded: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(x: Sequence[float], y: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., segments: bool = ..., loop: bool = ..., skip_nan: bool = ..., no_clip: bool = ..., shaded: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., segments: bool = ..., loop: bool = ..., skip_nan: bool = ..., no_clip: bool = ..., shaded: bool = ..., **kwargs) -> None: ...
...
class mvListbox(SupportsCallback, BasicType):
    ...
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(items: Sequence[str] = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: str = ..., num_items: int = ..., **kwargs) -> Item: ...
...
class mvLoadingIndicator(SupportsSized, BasicType):
    ...
    thickness: Property[float] = ...
    color: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    secondary_color: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., style: int = ..., circle_count: int = ..., speed: float = ..., radius: float = ..., thickness: float = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., secondary_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., style: int = ..., circle_count: int = ..., speed: float = ..., radius: float = ..., thickness: float = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., secondary_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., style: int = ..., circle_count: int = ..., speed: float = ..., radius: float = ..., thickness: float = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., secondary_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., **kwargs) -> None: ...
...
class mvMenu(ContainerType, BasicType):
    ...
    track_offset: Property[float] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., **kwargs) -> None: ...
...
class mvMenuBar(ContainerType, BasicType):
    ...
    show: Property[bool] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., show: bool = ..., delay_search: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., show: bool = ..., delay_search: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., show: bool = ..., **kwargs) -> None: ...
...
class mvMenuItem(SupportsCallback, BasicType):
    ...
    check: Property[bool] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: bool = ..., shortcut: str = ..., check: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: bool = ..., shortcut: str = ..., check: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., payload_type: str = ..., callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., shortcut: str = ..., check: bool = ..., **kwargs) -> None: ...
...
class mvMouseClickHandler(SupportsCallback, HandlerType, BasicType):
    ...
    show: Property[bool] = ...
    @overload
    def __init__(self, button: int = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., parent: 'Item' = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(button: int = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., parent: 'Item' = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., callback: Callable | None = ..., show: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'callback', 'show'], Any]: ...
...
class mvMouseDragHandler(SupportsCallback, HandlerType, BasicType):
    ...
    show: Property[bool] = ...
    @overload
    def __init__(self, button: int = ..., threshold: float = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., parent: 'Item' = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(button: int = ..., threshold: float = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., parent: 'Item' = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., callback: Callable | None = ..., show: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'callback', 'show'], Any]: ...
...
class mvMouseMoveHandler(SupportsCallback, HandlerType, BasicType):
    ...
    show: Property[bool] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., parent: 'Item' = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., parent: 'Item' = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., callback: Callable | None = ..., show: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'callback', 'show'], Any]: ...
...
class mvNode(NodeType, ContainerType, BasicType):
    ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., draggable: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., draggable: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., draggable: bool = ..., **kwargs) -> None: ...
...
class mvNodeAttribute(NodeType, ContainerType, BasicType):
    ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., attribute_type: int = ..., shape: int = ..., category: str = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., attribute_type: int = ..., shape: int = ..., category: str = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., show: bool = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., attribute_type: int = ..., shape: int = ..., category: str = ..., **kwargs) -> None: ...
...
class mvNodeEditor(SupportsCallback, NodeEditorType, ContainerType, BasicType):
    ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., parent: 'Item' = ..., before: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., delink_callback: Callable | None = ..., menubar: bool = ..., minimap: bool = ..., minimap_location: int = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., parent: 'Item' = ..., before: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., delink_callback: Callable | None = ..., menubar: bool = ..., minimap: bool = ..., minimap_location: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., callback: Callable | None = ..., show: bool = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., delink_callback: Callable | None = ..., menubar: bool = ..., minimap: bool = ..., minimap_location: int = ..., **kwargs) -> None: ...
...
class mvNodeLink(NodeType, BasicType):
    ...
    show: Property[bool] = ...
    @overload
    def __init__(self, attr_1: 'Item', attr_2: 'Item', *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., show: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(attr_1: 'Item', attr_2: 'Item', *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., show: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'show'], Any]: ...
...
class mvPieSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    Args:
        ...
        * normalize (bool, optional): force normalization of pie chart values (i.e. always
        make a full circle if sum < 0).

        * ignore_hidden (bool, optional): ignore hidden slices when drawing the pie chart
    ...
    ignore_hidden: Property[bool] = ...
    @overload
    def __init__(self, x: float, y: float, radius: float, values: Sequence[float], labels: Sequence[str], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., format: str = ..., angle: float = ..., normalize: bool = ..., ignore_hidden: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(x: float, y: float, radius: float, values: Sequence[float], labels: Sequence[str], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., format: str = ..., angle: float = ..., normalize: bool = ..., ignore_hidden: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., format: str = ..., angle: float = ..., normalize: bool = ..., ignore_hidden: bool = ..., **kwargs) -> None: ...
...
class mvPlot(SupportsSized, SupportsCallback, PlotType, ContainerType, BasicType):
    """Adds a plot which is used to hold series, and can be drawn to with draw commands. For all
    _mod parameters use mvKey_ModX enums, or mvKey_ModDisabled to disable the modifier.
    ...
    Args:
        ...
        * no_mouse_pos (bool, optional): the text of mouse position, in plot coordinates,
        will not be displayed inside of the plot.

        * query (bool, optional): the user will be able to draw query rects with CTRL +
        right-click drag.

        * query_color (Sequence[float], optional): Color of the query rectangles.

        * min_query_rects (int, optional): The minimum number of query rects that can be in
        the plot. If there are less rects than this value, it won't be possible to delete
        them.

        * max_query_rects (int, optional): The maximum number of query rects that can be in
        the plot. If the number is reached any rect added will replace the latest one. (0
        means unlimited).
        ...
        * context_menu_button (int, optional): opens context menus (if enabled) when
        clicked.
        ...
        * override_mod (int, optional): when held, all input is ignored; used to enable
        axis/plots as DND sources.

        * zoom_mod (int, optional): optional modifier that must be held for scroll wheel
        zooming.

        * zoom_rate (int, optional): zoom rate for scroll (e.g. 0.1f = 10% plot range every
        scroll click); make negative to invert.
    ...
    query: Property[bool] = ...
    query_color: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    min_query_rects: Property[int] = ...
    max_query_rects: Property[int] = ...
    ...
    override_mod: Property[int] = ...
    zoom_mod: Property[int] = ...
    zoom_rate: Property[int] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., no_title: bool = ..., no_menus: bool = ..., no_box_select: bool = ..., no_mouse_pos: bool = ..., query: bool = ..., query_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., min_query_rects: int = ..., max_query_rects: int = ..., crosshairs: bool = ..., equal_aspects: bool = ..., no_inputs: bool = ..., no_frame: bool = ..., use_local_time: bool = ..., use_ISO8601: bool = ..., use_24hour_clock: bool = ..., pan_button: int = ..., pan_mod: int = ..., context_menu_button: int = ..., fit_button: int = ..., box_select_button: int = ..., box_select_mod: int = ..., box_select_cancel_button: int = ..., query_toggle_mod: int = ..., horizontal_mod: int = ..., vertical_mod: int = ..., override_mod: int = ..., zoom_mod: int = ..., zoom_rate: int = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., no_title: bool = ..., no_menus: bool = ..., no_box_select: bool = ..., no_mouse_pos: bool = ..., query: bool = ..., query_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., min_query_rects: int = ..., max_query_rects: int = ..., crosshairs: bool = ..., equal_aspects: bool = ..., no_inputs: bool = ..., no_frame: bool = ..., use_local_time: bool = ..., use_ISO8601: bool = ..., use_24hour_clock: bool = ..., pan_button: int = ..., pan_mod: int = ..., context_menu_button: int = ..., fit_button: int = ..., box_select_button: int = ..., box_select_mod: int = ..., box_select_cancel_button: int = ..., query_toggle_mod: int = ..., horizontal_mod: int = ..., vertical_mod: int = ..., override_mod: int = ..., zoom_mod: int = ..., zoom_rate: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., no_title: bool = ..., no_menus: bool = ..., no_box_select: bool = ..., no_mouse_pos: bool = ..., query: bool = ..., query_color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., min_query_rects: int = ..., max_query_rects: int = ..., crosshairs: bool = ..., equal_aspects: bool = ..., no_inputs: bool = ..., no_frame: bool = ..., use_local_time: bool = ..., use_ISO8601: bool = ..., use_24hour_clock: bool = ..., pan_button: int = ..., pan_mod: int = ..., context_menu_button: int = ..., fit_button: int = ..., box_select_button: int = ..., box_select_mod: int = ..., box_select_cancel_button: int = ..., query_toggle_mod: int = ..., horizontal_mod: int = ..., vertical_mod: int = ..., override_mod: int = ..., zoom_mod: int = ..., zoom_rate: int = ..., **kwargs) -> None: ...
...
class mvPlotAxis(PlotAxisType, ContainerType, BasicType):
    ...
    Args:
        ...
        * no_initial_fit (bool, optional): axis will not be initially fit to data extents on
        the first rendered frame.

        * no_menus (bool, optional): the user will not be able to open context menus with
        right-click.

        * no_side_switch (bool, optional): the user will not be able to switch the axis side
        by dragging it.

        * no_highlight (bool, optional): the axis will not have its background highlighted
        when hovered or held.

        * opposite (bool, optional): axis ticks and labels will be rendered on the
        conventionally opposite side (i.e, right or top).

        * foreground_grid (bool, optional): grid lines will be displayed in the foreground
        (i.e. on top of data) instead of the background.
        ...
        * invert (bool, optional): the axis values will be inverted (i.e. growing from right
        to left).

        * auto_fit (bool, optional): axis will be auto-fitting to data extents.

        * range_fit (bool, optional): axis will only fit points if the point is in the
        visible range of the **orthogonal** axis.

        * pan_stretch (bool, optional): panning in a locked or constrained state will cause
        the axis to stretch if possible.

        * lock_min (bool, optional): the axis minimum value will be locked when
        panning/zooming.

        * lock_max (bool, optional): the axis maximum value will be locked when
        panning/zooming.
    ...
    no_initial_fit: Property[bool] = ...
    no_menus: Property[bool] = ...
    no_side_switch: Property[bool] = ...
    no_highlight: Property[bool] = ...
    opposite: Property[bool] = ...
    foreground_grid: Property[bool] = ...
    tick_format: Property[str] = ...
    scale: Property[int] = ...
    invert: Property[bool] = ...
    auto_fit: Property[bool] = ...
    range_fit: Property[bool] = ...
    pan_stretch: Property[bool] = ...
    lock_min: Property[bool] = ...
    lock_max: Property[bool] = ...
    @overload
    def __init__(self, axis: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., no_label: bool = ..., no_gridlines: bool = ..., no_tick_marks: bool = ..., no_tick_labels: bool = ..., no_initial_fit: bool = ..., no_menus: bool = ..., no_side_switch: bool = ..., no_highlight: bool = ..., opposite: bool = ..., foreground_grid: bool = ..., tick_format: str = ..., scale: int = ..., invert: bool = ..., auto_fit: bool = ..., range_fit: bool = ..., pan_stretch: bool = ..., lock_min: bool = ..., lock_max: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(axis: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., no_label: bool = ..., no_gridlines: bool = ..., no_tick_marks: bool = ..., no_tick_labels: bool = ..., no_initial_fit: bool = ..., no_menus: bool = ..., no_side_switch: bool = ..., no_highlight: bool = ..., opposite: bool = ..., foreground_grid: bool = ..., tick_format: str = ..., scale: int = ..., invert: bool = ..., auto_fit: bool = ..., range_fit: bool = ..., pan_stretch: bool = ..., lock_min: bool = ..., lock_max: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., no_label: bool = ..., no_gridlines: bool = ..., no_tick_marks: bool = ..., no_tick_labels: bool = ..., no_initial_fit: bool = ..., no_menus: bool = ..., no_side_switch: bool = ..., no_highlight: bool = ..., opposite: bool = ..., foreground_grid: bool = ..., tick_format: str = ..., scale: int = ..., invert: bool = ..., auto_fit: bool = ..., range_fit: bool = ..., pan_stretch: bool = ..., lock_min: bool = ..., lock_max: bool = ..., **kwargs) -> None: ...
...
class mvPlotLegend(PlottingType, BasicType):
    ...
    Args:
        ...
        * no_highlight_item (bool, optional): plot items will not be highlighted when their
        legend entry is hovered.

        * no_highlight_axis (bool, optional): axes will not be highlighted when legend
        entries are hovered (only relevant if x/y-axis count > 1).
    ...
    no_highlight_item: Property[bool] = ...
    no_highlight_axis: Property[bool] = ...
    no_menus: Property[bool] = ...
    no_buttons: Property[bool] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., location: int = ..., horizontal: bool = ..., sort: bool = ..., outside: bool = ..., no_highlight_item: bool = ..., no_highlight_axis: bool = ..., no_menus: bool = ..., no_buttons: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., location: int = ..., horizontal: bool = ..., sort: bool = ..., outside: bool = ..., no_highlight_item: bool = ..., no_highlight_axis: bool = ..., no_menus: bool = ..., no_buttons: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., location: int = ..., horizontal: bool = ..., sort: bool = ..., outside: bool = ..., no_highlight_item: bool = ..., no_highlight_axis: bool = ..., no_menus: bool = ..., no_buttons: bool = ..., **kwargs) -> None: ...
...
class mvProgressBar(SupportsSized, BasicType):
    ...
    Args:
        ...
        * default_value (float, optional): Normalized value to fill the bar from 0.0 to 1.0.
        Put a negative value to show an indeterminate progress bar.
    ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., overlay: str = ..., default_value: float = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., source: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., overlay: str = ..., **kwargs) -> None: ...
...
class mvRadioButton(SupportsCallback, BasicType):
    ...
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(items: Sequence[str] = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: str = ..., horizontal: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., horizontal: bool = ..., **kwargs) -> None: ...
...
class mvRawTexture(BasicType):
    ...
    format: Property[int] = ...
    @overload
    def __init__(self, width: int, height: int, default_value: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., format: int = ..., parent: 'Item' = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(width: int, height: int, default_value: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., format: int = ..., parent: 'Item' = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., format: int = ..., **kwargs) -> None: ...
...
class mvScatterSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    no_clip: Property[bool] = ...
    @overload
    def __init__(self, x: Sequence[float], y: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., no_clip: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(x: Sequence[float], y: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., no_clip: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., no_clip: bool = ..., **kwargs) -> None: ...
...
class mvSelectable(SupportsSized, SupportsCallback, BasicType):
    ...
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: bool = ..., span_columns: bool = ..., disable_popup_close: bool = ..., **kwargs) -> Item: ...
...
class mvSeparator(BasicType):
    """Adds a horizontal line separator. Use 'label' parameter to add text and
    mvStyleVar_SeparatorText* elements to style it.
    ...
    pos: Property[tuple[int, int] | list[int]] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'indent', 'show'], Any]: ...
...
class mvShadeSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    y2: Property[Any] = ...
    @overload
    def __init__(self, x: Sequence[float], y1: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., y2: Any = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(x: Sequence[float], y1: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., y2: Any = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., y2: Any = ..., **kwargs) -> None: ...
...
class mvSimplePlot(PlottingType, BasicType):
    ...
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: Sequence[float] = ..., overlay: str = ..., histogram: bool = ..., autosize: bool = ..., min_scale: float = ..., max_scale: float = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., source: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., overlay: str = ..., histogram: bool = ..., autosize: bool = ..., min_scale: float = ..., max_scale: float = ..., **kwargs) -> None: ...
...
class mvSlider3D(SupportsSized, SupportsCallback, BasicType):
    ...
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: Sequence[float] = ..., max_x: float = ..., max_y: float = ..., max_z: float = ..., min_x: float = ..., min_y: float = ..., min_z: float = ..., scale: float = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., max_x: float = ..., max_y: float = ..., max_z: float = ..., min_x: float = ..., min_y: float = ..., min_z: float = ..., scale: float = ..., **kwargs) -> None: ...
...
class mvSliderDouble(SupportsSized, SupportsCallback, BasicType):
    ...
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: float = ..., vertical: bool = ..., no_input: bool = ..., clamped: bool = ..., min_value: float = ..., max_value: float = ..., format: str = ..., **kwargs) -> Item: ...
...
class mvSliderIntMulti(SupportsCallback, BasicType):
    ...
    format: Property[str] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., size: int = ..., no_input: bool = ..., clamped: bool = ..., min_value: int = ..., max_value: int = ..., format: str = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., size: int = ..., no_input: bool = ..., clamped: bool = ..., min_value: int = ..., max_value: int = ..., format: str = ..., **kwargs) -> Item: ...
...
class mvSpacer(SupportsSized, BasicType):
    ...
    pos: Property[tuple[int, int] | list[int]] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., **kwargs) -> None: ...
...
class mvStage(RootType):
    ...
    use_internal_label: Property[bool] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label'], Any]: ...
...
class mvStairSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    Args:
        ...
        * pre_step (bool, optional): the y value is continued constantly to the left from
    ...
    source: Property['Item'] = ...
    show: Property[bool] = ...
    pre_step: Property[bool] = ...
    shaded: Property[bool] = ...
    @overload
    def __init__(self, x: Sequence[float], y: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., pre_step: bool = ..., shaded: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(x: Sequence[float], y: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., pre_step: bool = ..., shaded: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., pre_step: bool = ..., shaded: bool = ..., **kwargs) -> None: ...
...
class mvStemSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    Args:
        ...
        * horizontal (bool, optional): stems will be rendered horizontally on the current
        y-axis.
    ...
    horizontal: Property[bool] = ...
    @overload
    def __init__(self, x: Sequence[float], y: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., horizontal: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(x: Sequence[float], y: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., horizontal: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., source: 'Item' = ..., show: bool = ..., horizontal: bool = ..., **kwargs) -> None: ...
...
class mvStringValue(BasicType):
    ...
    source: Property['Item'] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., source: 'Item' = ..., default_value: str = ..., parent: 'Item' = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., source: 'Item' = ..., default_value: str = ..., parent: 'Item' = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'source'], Any]: ...
...
class mvSubPlots(SupportsSized, SupportsCallback, PlottingType, ContainerType, BasicType):
    ...
    Args:
        ...
        * share_series (bool, optional): when set to True, series from all sub-plots will be
        shared to some extent, using a single common color set and showing them in a single
        legend in the subplots item. Otherwise each plot will be independent from others and
        will have its own legend.
    ...
    @overload
    def __init__(self, rows: int, columns: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., row_ratios: Sequence[float] = ..., column_ratios: Sequence[float] = ..., no_title: bool = ..., no_menus: bool = ..., no_resize: bool = ..., no_align: bool = ..., share_series: bool = ..., link_rows: bool = ..., link_columns: bool = ..., link_all_x: bool = ..., link_all_y: bool = ..., column_major: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(rows: int, columns: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., row_ratios: Sequence[float] = ..., column_ratios: Sequence[float] = ..., no_title: bool = ..., no_menus: bool = ..., no_resize: bool = ..., no_align: bool = ..., share_series: bool = ..., link_rows: bool = ..., link_columns: bool = ..., link_all_x: bool = ..., link_all_y: bool = ..., column_major: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., row_ratios: Sequence[float] = ..., column_ratios: Sequence[float] = ..., no_title: bool = ..., no_menus: bool = ..., no_resize: bool = ..., no_align: bool = ..., share_series: bool = ..., link_rows: bool = ..., link_columns: bool = ..., link_all_x: bool = ..., link_all_y: bool = ..., column_major: bool = ..., **kwargs) -> None: ...
...
class mvTab(ContainerType, BasicType):
    ...
    Args:
        ...
        * order_mode (int, optional): set using a constant: mvTabOrder_Reorderable: allows
    ...
    closable: Property[bool] = ...
    no_tooltip: Property[bool] = ...
    order_mode: Property[int] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., closable: bool = ..., no_tooltip: bool = ..., order_mode: int = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., closable: bool = ..., no_tooltip: bool = ..., order_mode: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., closable: bool = ..., no_tooltip: bool = ..., order_mode: int = ..., **kwargs) -> None: ...
...
class mvTabBar(SupportsCallback, ContainerType, BasicType):
    ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., reorderable: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., reorderable: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., reorderable: bool = ..., **kwargs) -> None: ...
...
class mvTabButton(SupportsCallback, BasicType):
    ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., no_reorder: bool = ..., leading: bool = ..., trailing: bool = ..., no_tooltip: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., no_reorder: bool = ..., leading: bool = ..., trailing: bool = ..., no_tooltip: bool = ..., **kwargs) -> None: ...
...
class mvTable(SupportsSized, SupportsCallback, TableItemType, ContainerType, BasicType):
    ...
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., header_row: bool = ..., clipper: bool = ..., inner_width: int = ..., policy: int = ..., freeze_rows: int = ..., freeze_columns: int = ..., sort_multi: bool = ..., sort_tristate: bool = ..., resizable: bool = ..., reorderable: bool = ..., hideable: bool = ..., sortable: bool = ..., context_menu_in_body: bool = ..., row_background: bool = ..., borders_innerH: bool = ..., borders_outerH: bool = ..., borders_innerV: bool = ..., borders_outerV: bool = ..., no_host_extendX: bool = ..., no_host_extendY: bool = ..., no_keep_columns_visible: bool = ..., precise_widths: bool = ..., no_clip: bool = ..., pad_outerX: bool = ..., no_pad_outerX: bool = ..., no_pad_innerX: bool = ..., scrollX: bool = ..., scrollY: bool = ..., no_saved_settings: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., header_row: bool = ..., clipper: bool = ..., inner_width: int = ..., policy: int = ..., freeze_rows: int = ..., freeze_columns: int = ..., sort_multi: bool = ..., sort_tristate: bool = ..., resizable: bool = ..., reorderable: bool = ..., hideable: bool = ..., sortable: bool = ..., context_menu_in_body: bool = ..., row_background: bool = ..., borders_innerH: bool = ..., borders_outerH: bool = ..., borders_innerV: bool = ..., borders_outerV: bool = ..., no_host_extendX: bool = ..., no_host_extendY: bool = ..., no_keep_columns_visible: bool = ..., precise_widths: bool = ..., no_clip: bool = ..., pad_outerX: bool = ..., no_pad_outerX: bool = ..., no_pad_innerX: bool = ..., scrollX: bool = ..., scrollY: bool = ..., no_saved_settings: bool = ..., **kwargs) -> None: ...
...
class mvTableCell(TableType, ContainerType, BasicType):
    ...
    filter_key: Property[str] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., height: int = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., filter_key: str = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., height: int = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., filter_key: str = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., height: int = ..., show: bool = ..., filter_key: str = ..., **kwargs) -> None: ...
...
class mvTableColumn(TableType, BasicType):
    ...
    Args:
        ...
        * angled_header (bool, optional): Set this parameter to True to display the header
        text for this column in an angled (diagonal) orientation. This will add an
        additional row to accommodate the angled text.

        * no_header_label (bool, optional): Disable horizontal label for this column. Name
        will still appear in context menu or in angled headers.
...
class mvText(BasicType):
    ...
    show_label: Property[bool] = ...
    @overload
    def __init__(self, default_value: str = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., wrap: int = ..., bullet: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., show_label: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(default_value: str = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., wrap: int = ..., bullet: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., show_label: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., source: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., wrap: int = ..., bullet: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., show_label: bool = ..., **kwargs) -> None: ...
...
class mvThemeColor(SupportsValueArray, ThemeElementType, BasicType):
    ...
    use_internal_label: Property[bool] = ...
    @overload
    def __init__(self, target: int = ..., value: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., category: int = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(target: int = ..., value: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., category: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., **kwargs) -> None: ...
...
class mvThemeComponent(ThemeElementType, ContainerType, BasicType):
    ...
    @overload
    def __init__(self, item_type: int = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., enabled_state: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(item_type: int = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., enabled_state: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., enabled_state: bool = ..., **kwargs) -> None: ...
...
class mvThemeStyle(SupportsValueArray, ThemeElementType, BasicType):
    ...
    use_internal_label: Property[bool] = ...
    @overload
    def __init__(self, target: int = ..., x: float = ..., y: float = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., category: int = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(target: int = ..., x: float = ..., y: float = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., category: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'category', 'target'], Any]: ...
...
class mvTimePicker(SupportsCallback, BasicType):
    ...
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: dict = ..., hour24: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., hour24: bool = ..., **kwargs) -> None: ...
...
class mvTooltip(ContainerType, BasicType):
    ...
    Args:
        ...
        * delay (float, optional): Activation delay: time, in seconds, during which the
        mouse should stay still in order to display the tooltip.  May be zero for instant
        activation.

        * hide_on_activity (bool, optional): Hide the tooltip if the user has moved the
        mouse.  If False, the tooltip will follow mouse pointer.
    ...
    use_internal_label: Property[bool] = ...
    show: Property[bool] = ...
    delay: Property[float] = ...
    hide_on_activity: Property[bool] = ...
    @overload
    def __init__(self, parent: 'Item', *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., show: bool = ..., delay: float = ..., hide_on_activity: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(parent: 'Item', *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., show: bool = ..., delay: float = ..., hide_on_activity: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., delay: float = ..., hide_on_activity: bool = ..., **kwargs) -> None: ...
...
class mvTreeNode(ContainerType, BasicType):
    ...
    Args:
        ...
        * span_full_width (bool, optional): Extend hit box to the left-most and right-most
        edges (cover the indent area).
    ...
    span_text_width: Property[bool] = ...
    span_full_width: Property[bool] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., default_open: bool = ..., open_on_double_click: bool = ..., open_on_arrow: bool = ..., leaf: bool = ..., bullet: bool = ..., selectable: bool = ..., span_text_width: bool = ..., span_full_width: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., default_open: bool = ..., open_on_double_click: bool = ..., open_on_arrow: bool = ..., leaf: bool = ..., bullet: bool = ..., selectable: bool = ..., span_text_width: bool = ..., span_full_width: bool = ..., **kwargs) -> Item: ...
...
class mvViewportDrawlist(DrawingType, RootType):
    ...
    front: Property[bool] = ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., show: bool = ..., filter_key: str = ..., delay_search: bool = ..., front: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., show: bool = ..., filter_key: str = ..., delay_search: bool = ..., front: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., filter_key: str = ..., front: bool = ..., **kwargs) -> None: ...
...
class mvWindowAppItem(SupportsSized, WindowType, RootType):
    ...
    Args:
        ...
        * unsaved_document (bool, optional): Show a special marker if the document is not
        saved.
    ...
    autosize: Property[bool] = ...
    no_resize: Property[bool] = ...
    unsaved_document: Property[bool] = ...
    ...
    @overload
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., delay_search: bool = ..., min_size: Sequence[int] = ..., max_size: Sequence[int] = ..., menubar: bool = ..., collapsed: bool = ..., autosize: bool = ..., no_resize: bool = ..., unsaved_document: bool = ..., no_title_bar: bool = ..., no_move: bool = ..., no_scrollbar: bool = ..., no_collapse: bool = ..., horizontal_scrollbar: bool = ..., no_focus_on_appearing: bool = ..., no_bring_to_front_on_focus: bool = ..., no_close: bool = ..., no_background: bool = ..., modal: bool = ..., popup: bool = ..., no_saved_settings: bool = ..., no_open_over_existing_popup: bool = ..., no_scroll_with_mouse: bool = ..., on_close: Callable | None = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, *, tag: int | str) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., delay_search: bool = ..., min_size: Sequence[int] = ..., max_size: Sequence[int] = ..., menubar: bool = ..., collapsed: bool = ..., autosize: bool = ..., no_resize: bool = ..., unsaved_document: bool = ..., no_title_bar: bool = ..., no_move: bool = ..., no_scrollbar: bool = ..., no_collapse: bool = ..., horizontal_scrollbar: bool = ..., no_focus_on_appearing: bool = ..., no_bring_to_front_on_focus: bool = ..., no_close: bool = ..., no_background: bool = ..., modal: bool = ..., popup: bool = ..., no_saved_settings: bool = ..., no_open_over_existing_popup: bool = ..., no_scroll_with_mouse: bool = ..., on_close: Callable | None = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., min_size: Sequence[int] = ..., max_size: Sequence[int] = ..., menubar: bool = ..., collapsed: bool = ..., autosize: bool = ..., no_resize: bool = ..., unsaved_document: bool = ..., no_title_bar: bool = ..., no_move: bool = ..., no_scrollbar: bool = ..., no_collapse: bool = ..., horizontal_scrollbar: bool = ..., no_focus_on_appearing: bool = ..., no_bring_to_front_on_focus: bool = ..., no_close: bool = ..., no_background: bool = ..., modal: bool = ..., popup: bool = ..., no_saved_settings: bool = ..., no_open_over_existing_popup: bool = ..., no_scroll_with_mouse: bool = ..., on_close: Callable | None = ..., **kwargs) -> None: ...
...
AxisTag = mvAxisTag
BarGroupSeries = mvBarGroupSeries
